...
class TestVector(unittest.TestCase):
    ...
    def test_add_large_vectors(self):
        v1 = Vector(range(100))
        v2 = Vector(range(100, 200))
        expected = Vector(i + (i + 100) for i in range(100))
        self.assertEqual(v1 + v2, expected)

    def test_subtract_large_vectors(self):
        v1 = Vector(range(200, 300))
        v2 = Vector(range(100))
        expected = Vector(200 for _ in range(100))
        self.assertEqual(v1 - v2, expected)

    def test_scalar_multiply_large_vector(self):
        v = Vector(range(100))
    ...
    def test_dot_product_large_vectors(self):
        ...
        self.assertEqual(v1.dot(v2), 200)
